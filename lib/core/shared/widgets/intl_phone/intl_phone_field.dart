...
class IntlPhoneField extends StatefulWidget {
  ...
  /// {@macro flutter.me.editableText.readOnly}
  final bool readOnly;
  final FormFieldSetter<PhoneNumber>? onSaved;

  /// {@macro flutter.me.editableText.onChanged}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.me.editableText.keyboardType}
  ...
  /// {@macro flutter.me.editableText.onSubmitted}
  ///
  /// See also:
  ///
  ...
  /// {@macro flutter.me.editableText.inputFormatters}
  ...
  const IntlPhoneField({
    ...
    this.dropdownIcon = const Icon(Icons.arrow_drop_down, size: 25,),
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            padding: const EdgeInsetsDirectional.only(start: 13.0, end: 0.0),
            child: Row(
              ...
              children: <Widget>[
                FittedBox(
                  child: AppText(
                    ...
                    // color: (hasFocus && inputValue.isNotEmpty) || (!hasFocus && inputValue.isNotEmpty) ? Colors.black : const Color(0xFF707070),
                    // fontSize: (hasFocus && inputValue.isNotEmpty) || (!hasFocus && inputValue.isNotEmpty) ? 16 : 14,
                  ),
                ),
                if (widget.enabled && widget.showDropdownIcon && widget.dropdownIconPosition == IconPosition.trailing) ...[
                  ...
                  SizedBox(
                    width: 15,
                    height: 15,
                    child: Image.asset("assets/images/dropdownIcon_arrow.png"),
                  )
                ],
                const SizedBox(width: 2,),
                if (widget.showCountryFlag) ...[
                  kIsWeb
                      ? Image.asset('assets/flags/${_selectedCountry.code.toLowerCase()}.png', width: 25,)
